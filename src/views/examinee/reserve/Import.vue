    ...
    <div class="import">
        <div class="section">
            ...
            <ul class="explain">
                ...
                <li>2、模板文件格式请参考“<a href="javascript:;" class="sp" @click="download">考生预约报考信息模板.xlsx</a>”。</li>
    ...
    export default {
        ...
        methods: {
            ...
            upload () {
                ...
                examineeApi.reserveImport(formData).then((req)=>{
                    if(req.data.ret == 0){
            ...
            download () {
                examineeApi.reserveDownload().then((res)=>{
                    // if(req.data.ret == 0){
